...
def get_season_total(home_stat_id, away_stat_id, total_stat_id, season):
  ...
  total_insert = """INSERT INTO player_team_stats(stat_id, player_id, team_id, season_id, sum, count, average)
...
stat_insert = """INSERT INTO player_team_stats(stat_id, player_id, team_id, season_id, sum, count, average)
